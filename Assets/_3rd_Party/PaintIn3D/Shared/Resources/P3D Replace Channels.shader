	...
	SubShader
	{
		Pass
		{
			...
			CGPROGRAM
				...
				{
					o.color.r = dot(tex2D(_TextureR, i.texcoord), _ChannelR);
					o.color.g = dot(tex2D(_TextureG, i.texcoord), _ChannelG);
					o.color.b = dot(tex2D(_TextureB, i.texcoord), _ChannelB);
					o.color.a = dot(tex2D(_TextureA, i.texcoord), _ChannelA);
				}
			ENDCG
		} // Pass
	} // SubShader
